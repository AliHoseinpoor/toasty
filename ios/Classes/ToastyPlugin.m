...
static NSString *const CHANNEL_NAME = @"toasty";
...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    if([@"cancel" isEqualToString:call.method]) {
        ...
        NSNumber *bgcolor = call.arguments[@"back_color"];
        NSNumber *textcolor = call.arguments[@"font_color"];
        NSNumber *fontSize = call.arguments[@"font_size"];
